   ...
   <div class="main_content">
    ...
    <div class="tab-content">
          ...
          <form method="post" action="options.php" class = "form">
             <div class="input_field">
                 <?php 
                    ...
                    do_settings_sections( 'kommunicate_plugin' );
                  ?>
       ...
       <div id="tab-2" class="tab-pane">
          <div class="description">
             ...
             <ul class="description_steps">
                ...
                <li>Go to Plugin settings, then <b>Enter Your APP_ID</b> from kommunicate to enable chat widget.</li>
     ...
     <div class="kommunicate_footer-text">
         Don’t have an APP_ID? Go to <a href="https://kommunicate.io" target="_blank" class="kommunicate-anchor">&nbsp;kommunicate.io&nbsp;</a> and get your's!
     </div>
   </div>
</div>